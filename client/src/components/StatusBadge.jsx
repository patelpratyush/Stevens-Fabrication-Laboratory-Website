// Status badge component for orders, equipment, checkouts
...
/* Usage examples:
<StatusBadge status="submitted" type="order" />
<StatusBadge status="available" type="equipment" />
<StatusBadge status="pending" type="checkout" />
*/
